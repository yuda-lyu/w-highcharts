...
function main() {
    ...
    //url
    let url = `https://cdn.jsdelivr.net/npm/w-highcharts@${pks.version}/dist/w-highcharts.umd.js`
    let urlww = `https://cdn.jsdelivr.net/npm/w-highcharts@${pks.version}/dist/w-highcharts.wk.umd.js`
    ...
    _.each(ltfs, function(v) {
        ...
        //replace
        let r
        r = `../dist/w-highcharts.umd.js`
        c = c.replace(r, url)
        r = `../dist/w-highcharts.wk.umd.js`
        c = c.replace(r, urlww)
